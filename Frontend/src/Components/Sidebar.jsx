  ...
  return (
    <aside className="w-[30%] bg-[#121212] text-white flex flex-col p-3 font-sans rounded-lg overflow-y-auto">
      ...
      <nav className="flex flex-col mb-4">
        <div className="px-4 py-2 rounded flex items-center gap-3 font-bold">
      ...
      {!playlistCreated ? (
        <div className="bg-[#242424] rounded-lg p-4 mb-3 flex flex-col gap-3">
          ...
          <button
            className="rounded-full px-4 py-2 bg-white text-black font-bold w-fit hover:bg-[#e6e6e6] hover:scale-110 transition-transform"
        ...
        <div className="bg-[#242424] rounded-lg p-4 mb-3 flex items-center justify-between">
          {editing ? (
            <input
